...
## Sub-project B.5 — Runner unification (PLANNED, not started)
...
- **PRs:** PR 0 roadmap, PR 1 generic paper runner + delete shims, PR 2 generic backtest runner + 9 backtest YAMLs, PR 3 kronos parity + retire `KronosBacktestRunner`, PR 4 scaffold `LiveStrategyRunner` (raises `NotImplementedError` per 2026-04-21 no-real-money directive).
