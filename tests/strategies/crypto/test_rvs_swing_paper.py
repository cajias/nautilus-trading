"""RVSSwingPaperTradeRunner composition test.
...
def test_runner_builds_testnet_spot_config():
    runner = RVSSwingPaperTradeRunner(
    ...
    assert strat_entry.strategy_path == "strategies.crypto.rvs_swing:RVSSwingStrategy"
    assert strat_entry.config_path == "strategies.crypto.rvs_swing:RVSSwingConfig"
