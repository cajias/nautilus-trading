"""ShockGuardPaperTradeRunner — Binance Spot Testnet driver for ShockGuardStrategy."""
...
@dataclass
class ShockGuardPaperTradeRunner(PaperTradeRunner):
    """Drive ShockGuardStrategy against Binance Spot Testnet.
    ...
    Note: ShockGuard accepts only the base fields — all allocation/shock
    parameters have defaults on `ShockGuardConfig` so no additional runner
    ...
    def build_config(self) -> TradingNodeConfig:
        ...
        builder = STRATEGY_BUILDERS["shock_guard"]
